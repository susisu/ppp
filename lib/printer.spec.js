...
describe("print", () => {
    ...
    it("can print package author", async () => {
      {
        ...
        const text = await printer.print(pkg, ["author"], opts, npm);
    ...
    it("can print list of binaries", async () => {
      {
        ...
        const text = await printer.print(pkg, ["binaries"], opts, npm);
  ...
  describe("cpu", () => {
    it("can print list of supported cpu architectures", async () => {
      ...
      const text = await printer.print(pkg, ["cpu"], opts, npm);
  ...
  describe("dependencies", () => {
    it("can print list of dependencies", async () => {
      ...
      const text = await printer.print(pkg, ["dependencies"], opts, npm);
  ...
  describe("description", () => {
    it("can print package description", async () => {
      ...
      const text = await printer.print(pkg, ["description"], opts, npm);
  ...
  describe("devDependencies", () => {
    it("can print list of dev dependencies", async () => {
      ...
      const text = await printer.print(pkg, ["devDependencies"], opts, npm);
  ...
  describe("engines", () => {
    it("can print list of required engines", async () => {
      ...
      const text = await printer.print(pkg, ["engines"], opts, npm);
  ...
  describe("homepage", () => {
    it("can print package homepage", async () => {
      ...
      const text = await printer.print(pkg, ["homepage"], opts, npm);
  ...
  describe("installed", () => {
    it("can print installed versions", async () => {
      ...
      const text = await printer.print(pkg, ["installed"], opts, { ...npm, ls });
    ...
    it("skips if the package name does not exist or is invalid", async () => {
      const pkg = {};
      const text = await printer.print(pkg, ["installed"], opts, npm);
      expect(strip(text)).toBe("");
    });
  });
  ...
  describe("keywords", () => {
    it("can print list of keywords", async () => {
      ...
      const text = await printer.print(pkg, ["keywords"], opts, npm);
  ...
  describe("license", () => {
    it("can print license of the package", async () => {
      ...
      const text = await printer.print(pkg, ["license"], opts, npm);
  ...
  describe("maintainers", () => {
    it("can print list of maintainers", async () => {
      ...
      const text = await printer.print(pkg, ["maintainers"], opts, npm);
      expect(strip(text)).toBe(
        // prettier-ignore
        [
            "Maintainers :",
    ...
    it("can print whether the package provides ES2016 module or not", async () => {
      {
        ...
        const text = await printer.print(pkg, ["module"], opts, npm);
  ...
  describe("name", () => {
    it("can print package name", async () => {
      ...
      const text = await printer.print(pkg, ["name"], opts, npm);
  ...
  describe("npm", () => {
    it("can print package URL on npm", async () => {
      ...
      const text = await printer.print(pkg, ["npm"], opts, npm);
  ...
  describe("optionalDependencies", () => {
    it("can print list of optional dependencies", async () => {
      ...
      const text = await printer.print(pkg, ["optionalDependencies"], opts, npm);
  ...
  describe("os", () => {
    it("can print list of supported operating systems", async () => {
      ...
      const text = await printer.print(pkg, ["os"], opts, npm);
  ...
  describe("peerDependencies", () => {
    it("can print list of peer dependencies", async () => {
      ...
      const text = await printer.print(pkg, ["peerDependencies"], opts, npm);
    ...
    it("can print package repository", async () => {
      {
        ...
        const text = await printer.print(pkg, ["repository"], opts, npm);
  ...
  describe("shasum", () => {
    it("can print SHA checksum of the package", async () => {
      ...
      const text = await printer.print(pkg, ["shasum"], opts, npm);
    ...
    it("can print list of tags", async () => {
      {
        ...
        const text = await printer.print(pkg, ["tags"], opts, npm);
        expect(strip(text)).toBe(
          // prettier-ignore
          [
              "Tags :",
  ...
  describe("tarball", () => {
    it("can print URL of the package tarball", async () => {
      ...
      const text = await printer.print(pkg, ["tarball"], opts, npm);
    ...
    it("can print whether the package provides type definitions for TypeScript", async () => {
      {
        ...
        const text = await printer.print(pkg, ["types"], opts, npm);
    ...
    it("can print package version", async () => {
      {
        ...
        const text = await printer.print(pkg, ["version"], opts, npm);
  ...
  it("can print multiple fields", async () => {
    ...
    const text = await printer.print(pkg, ["name", "description"], opts, npm);
    expect(strip(text)).toBe(
      // prettier-ignore
      [
          "Name        : @susisu/ppp",
  ...
  it("throws error if unknown field is specified", async () => {
    const pkg = {};
    const promise = printer.print(pkg, ["unknown"], opts, npm);

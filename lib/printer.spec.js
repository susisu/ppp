...
describe("print", () => {
    ...
    it("prints the package author", async () => {
      {
        ...
        const text = await printer.print(pkg, ["author"], opts, {});
    ...
    it("prints the list of the binaries", async () => {
      {
        ...
        const text = await printer.print(pkg, ["binaries"], opts, {});
  ...
  describe("cpu", () => {
    it("prints the list of the supported cpu architectures", async () => {
      ...
      const text = await printer.print(pkg, ["cpu"], opts, {});
  ...
  describe("dependencies", () => {
    it("prints the list of the dependencies", async () => {
      ...
      const text = await printer.print(pkg, ["dependencies"], opts, {});
  ...
  describe("description", () => {
    it("prints the package description", async () => {
      ...
      const text = await printer.print(pkg, ["description"], opts, {});
  ...
  describe("devDependencies", () => {
    it("prints the list of the dev dependencies", async () => {
      ...
      const text = await printer.print(pkg, ["devDependencies"], opts, {});
  ...
  describe("engines", () => {
    it("prints the list of the required engines", async () => {
      ...
      const text = await printer.print(pkg, ["engines"], opts, {});
  ...
  describe("homepage", () => {
    it("prints the package homepage", async () => {
      ...
      const text = await printer.print(pkg, ["homepage"], opts, {});
  ...
  describe("installed", () => {
    it("prints the installed versions", async () => {
      ...
      const text = await printer.print(pkg, ["installed"], opts, { ls });
    ...
    it("skips if the package name does not exist or is invalid", async () => {
      const pkg = {};
      const text = await printer.print(pkg, ["installed"], opts, {});
      expect(strip(text)).toBe("");
    });
  });
  ...
  describe("keywords", () => {
    it("prints the list of the keywords", async () => {
      ...
      const text = await printer.print(pkg, ["keywords"], opts, {});
  ...
  describe("license", () => {
    it("prints the license of the package", async () => {
      ...
      const text = await printer.print(pkg, ["license"], opts, {});
  ...
  describe("maintainers", () => {
    it("prints the list of the maintainers", async () => {
      ...
      const text = await printer.print(pkg, ["maintainers"], opts, {});
      expect(strip(text)).toBe(
        // prettier-ignore
        [
            "Maintainers :",
    ...
    it("prints whether the package provides ES2016 module or not", async () => {
      {
        ...
        const text = await printer.print(pkg, ["module"], opts, {});
  ...
  describe("name", () => {
    it("prints the package name", async () => {
      ...
      const text = await printer.print(pkg, ["name"], opts, {});
  ...
  describe("npm", () => {
    it("prints the package URL on npm", async () => {
      ...
      const text = await printer.print(pkg, ["npm"], opts, {});
  ...
  describe("optionalDependencies", () => {
    it("prints the list of the optional dependencies", async () => {
      ...
      const text = await printer.print(pkg, ["optionalDependencies"], opts, {});
  ...
  describe("os", () => {
    it("prints the list of the supported operating systems", async () => {
      ...
      const text = await printer.print(pkg, ["os"], opts, {});
  ...
  describe("peerDependencies", () => {
    it("prints the list of the peer dependencies", async () => {
      ...
      const text = await printer.print(pkg, ["peerDependencies"], opts, {});
    ...
    it("prints the package repository", async () => {
      {
        ...
        const text = await printer.print(pkg, ["repository"], opts, {});
  ...
  describe("shasum", () => {
    it("prints the SHA checksum of the package", async () => {
      ...
      const text = await printer.print(pkg, ["shasum"], opts, {});
    ...
    it("prints the list of the available tags", async () => {
      {
        ...
        const text = await printer.print(pkg, ["tags"], opts, {});
        expect(strip(text)).toBe(
          // prettier-ignore
          [
              "Tags :",
  ...
  describe("tarball", () => {
    it("prints the URL of the package tarball", async () => {
      ...
      const text = await printer.print(pkg, ["tarball"], opts, {});
    ...
    it("prints whether the package provides type definitions for TypeScript", async () => {
      {
        ...
        const text = await printer.print(pkg, ["types"], opts, {});
    ...
    it("prints the package version", async () => {
      {
        ...
        const text = await printer.print(pkg, ["version"], opts, {});
  ...
  it("prints multiple fields", async () => {
    ...
    const text = await printer.print(pkg, ["name", "description"], opts, {});
    expect(strip(text)).toBe(
      // prettier-ignore
      [
          "Name        : @susisu/ppp",
  ...
  it("throws error if unknown field is specified", async () => {
    const pkg = {};
    const promise = printer.print(pkg, ["unknown"], opts, {});
